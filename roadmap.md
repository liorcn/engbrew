...
<h2><a href="{{ site.baseurl }}//">ראשי</a></h2>
...
<h2><a href="{{ site.baseurl }}/about/">אודות</a></h2>

<p>בדף זה נכתב על הסיבה שבשמה האתר הוקם.</p>


<h2><a href="{{ site.baseurl }}/sources/">מקורות לימוד</a></h2>
...
<h2><a href="{{ site.baseurl }}/translations-index/">אוסף תרגומים</a></h2>
...
<h2><a href="{{ site.baseurl }}/contact/">צור קשר</a></h2>
...
<table class="table text-center">
  ...
  <tr>
    <td>1</td>
    <td><a href="{{ site.baseurl }}/learning-how-to-learn/">ללמוד איך ללמוד</a></td>
    <td>ליישם בלמידה את השיטות שמופיעות שם.</td>
  </tr>
  <tr>
    <td>2</td>
    <td>לקרוא את החלק <a href="{{ site.baseurl }}/reading/">קריאה</a></td>
    <td>
  ...
  <tr>
    <td>3</td>
    <td>ללמוד זמנים בצורה יסודית לפי סדר הזמנים בעמוד <a href="{{ site.baseurl }}/grammar/">דקדוק</a>.</td>
    <td>
  ...
  <tr>
    <td>4</td>
    <td><a href="{{ site.baseurl }}/writing/">כתיבה</a></td>
    <td>לשים דגש על צבירת ניסיון, לא לפחד לטעות – לכתוב.</td>
  </tr>
  <tr>
    <td>5</td>
    <td><a href="{{ site.baseurl }}/speaking/">שמיעה ודיבור</a> – לימוד אנגלית מדוברת</td>
